...
class SelectCourseTimetableStudentScreen extends StatelessWidget {
  final String degreeLevel;
  const SelectCourseTimetableStudentScreen({super.key, required this.degreeLevel});
                  ...
                  return InkWell(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (_) => const StudentViewHallAllotmentScreen(),
                        ),
                      );
                    },
