...
class SelectDegreeTimetableStudentScreen extends StatelessWidget {
  const SelectDegreeTimetableStudentScreen({super.key});
            ...
            _degreeCard(
              ...
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (_) => const SelectCourseTimetableStudentScreen(degreeLevel: 'Undergraduate'),
                  ),
                );
              },
            ),
            ...
            _degreeCard(
              ...
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (_) => const SelectCourseTimetableStudentScreen(degreeLevel: 'Postgraduate'),
                  ),
                );
              },
            ),
