...
class SelectCoursePostgradScreen extends StatelessWidget {
  const SelectCoursePostgradScreen({super.key});
                ...
                itemBuilder: (context, index) {
                  ...
                  return InkWell(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (_) => SelectSemesterScreen(courseTitle: title, degreeLevel: 'Postgraduate')),
                      );
                    },
